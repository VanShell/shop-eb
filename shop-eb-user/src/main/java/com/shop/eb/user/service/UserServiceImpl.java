package com.shop.eb.user.service;

import com.shop.be.common.api.cache.DLockApi;
import com.shop.be.common.api.cache.RedisServiceApi;
import com.shop.be.common.api.cache.vo.SkUserKeyPrefix;
import com.shop.be.common.api.user.UserServiceApi;
import com.shop.be.common.api.user.vo.LoginVo;
import com.shop.be.common.api.user.vo.RegisterVo;
import com.shop.be.common.api.user.vo.UserInfoVo;
import com.shop.be.common.api.user.vo.UserVo;
import com.shop.be.common.exception.GlobalException;
import com.shop.be.common.result.CodeMsg;
import com.shop.be.common.util.MD5Util;
import com.shop.be.common.util.UUIDUtil;
import com.shop.eb.user.domain.SeckillUser;
import com.shop.eb.user.persistence.SeckillUserMapper;
