package com.shop.eb.gateway.seckill;

import com.shop.be.common.api.cache.RedisServiceApi;
import com.shop.be.common.api.cache.vo.GoodsKeyPrefix;
import com.shop.be.common.api.cache.vo.OrderKeyPrefix;
import com.shop.be.common.api.cache.vo.SkKeyPrefix;
import com.shop.be.common.api.goods.GoodsServiceApi;
import com.shop.be.common.api.goods.vo.GoodsVo;
import com.shop.be.common.api.mq.MqProviderApi;
import com.shop.be.common.api.mq.vo.SkMessage;
import com.shop.be.common.api.order.OrderServiceApi;
import com.shop.be.common.api.seckill.SeckillServiceApi;
import com.shop.be.common.api.seckill.vo.VerifyCodeVo;
import com.shop.be.common.api.user.vo.UserVo;
import com.shop.be.common.domain.SeckillOrder;
import com.shop.be.common.result.CodeMsg;
import com.shop.be.common.result.Result;
import com.shop.be.common.util.MD5Util;
import com.shop.be.common.util.UUIDUtil;
import com.shop.be.common.util.VerifyCodeUtil;
import com.shop.eb.gateway.config.access.AccessLimit;
